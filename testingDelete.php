...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
   ...
   {
    deleteNotes($_POST['notesId'], $_POST['studentId']);
   }
}
?>
...
<body style="background-color:#f7f7ff;">
    <br>
  <div class="container">
  <h1 class="display-4">delete Notes!</h1>
  <form name="notesForm" action="testingDelete.php" method="post">
    ...
    <br>
    <center><button value = "Add Notes" type="submit" name="delBtn" class="btn btn-info" style="background-color:#E53E3E">del Notes</button></center>
</form>
</div>
<hr/>
<div class="container">
